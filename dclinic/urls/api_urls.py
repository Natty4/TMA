...
from dclinic.views.api_views import (
    ...
    BusinessServiceProfessionalsView,
...
urlpatterns = [
    ...
    path('businesses/<int:business_id>/services/<int:service_id>/professionals/', BusinessServiceProfessionalsView.as_view(), name='business-service-professionals'),
